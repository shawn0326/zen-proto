...
impl DrawPreparePass {
	pub fn new(
		...
		let module = device.create_shader_module(wgpu::ShaderModuleDescriptor {
			...
			source: wgpu::ShaderSource::Wgsl(include_str!("../../shaders/draw_prepare.wgsl").into()),
		});
	...
	pub fn encode_indirect(&self, encoder: &mut wgpu::CommandEncoder, dispatch_args_buffer: &wgpu::Buffer) {
