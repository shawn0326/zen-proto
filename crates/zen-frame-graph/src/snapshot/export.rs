...
use super::{
    ...
    SnapshotGpuNodeTiming, SnapshotGpuTimings, SnapshotGraph, SnapshotGroup, SnapshotLifetime,
    SnapshotMemory, SnapshotNode, SnapshotNodeCompileState, SnapshotNodeKind, SnapshotPoolReport,
    SnapshotProducer, SnapshotResource, SnapshotResourceDescriptor, SnapshotResourceKind,
    SnapshotResourceOrigin, SnapshotRoot, SnapshotRootReason, SnapshotRuntime, SnapshotSegment,
    SnapshotSegmentKind, SnapshotTextureRegion, SnapshotTextureSize, SnapshotTextureView,
    SnapshotTimings, SnapshotUsageFlag, SnapshotWriteContents,
};
            ...
            .map(|(recording_order, source)| {
                ...
                match source {
                    Source::Retained(node) => Ok(SnapshotNode {
                        ...
                        recording_order: recording_order.into(),
        ...
        for root in &self.full.roots {
            ...
            roots.insert(SnapshotRoot {
                reason: match root.reason {
                    ...
                    RootReason::PersistentState => SnapshotRootReason::SideEffect,
                },
                node_id: None,
